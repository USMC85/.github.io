The K-Rod page for a digital forensic company I want to start.  The logo in the upper left corner uses some of the code to spin the log when the mouse rolls over it.  The menu will eventually stack into a single column for smaller screens.  The logo will pop out to the very top as the screen gets smaller.
